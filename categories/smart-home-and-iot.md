...
- [homebridge](https://clawskills.sh/skills/jiasenl-clawdbot-skill-homebridge) - Control smart home devices via Homebridge Config UI X.
- [homey](https://clawskills.sh/skills/maxsumrall-homey) - Control Athom Homey smart home devices via local (LAN/VPN) or cloud APIs.
- [homey-cli](https://clawskills.sh/skills/krausefx-homey-cli) - Control Homey home automation hub.
- [icom-7610](https://clawskills.sh/skills/morozsm-icom-7610) - Control an Icom IC-7610 transceiver over USB/LAN.
- [internet-lookup-verifier](https://clawskills.sh/skills/amangarg1999-internet-lookup-verifier) - Verify information by performing.
- [ipcam](https://clawskills.sh/skills/ltpop-ipcam) - ONVIF PTZ control + RTSP capture + camera discovery.
