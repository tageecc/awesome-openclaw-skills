...
- [mlx-tts](https://clawskills.sh/skills/guoqiao-mlx-tts) - Text-To-Speech with MLX (Apple Silicon) and opensource models (default QWen3-TTS) locally.
- [mole-mac-cleanup](https://clawskills.sh/skills/bjesuiter-mole-mac-cleanup) - Mac cleanup & optimization tool combining CleanMyMac.
- [monolith](https://clawskills.sh/skills/slaviquee-monolith) - Secure crypto wallet for AI agents.
- [my-tesla](https://clawskills.sh/skills/officialpm-my-tesla) - Control Tesla vehicles from macOS via the Tesla Owner API using teslapy.
- [network-scanner](https://clawskills.sh/skills/florianbeer-network-scanner) - Scan networks to discover devices, gather MAC addresses.
- [omarchy](https://clawskills.sh/skills/achals-iglu-omarchy) - Omarchy operating guardrails for day-to-day system work: assume the host is Omarchy by default, choose.
- [pattern-finder](https://clawskills.sh/skills/leegitw-pattern-finder) - Discover what two sources agree on — find the signal.
- [say](https://clawskills.sh/skills/tobihagemann-say) - Text-to-Speech via macOS say command with Siri Natural Voices.
- [shortcuts-generator](https://clawskills.sh/skills/erik-agens-shortcuts-skill) - Generate macOS/iOS Shortcuts by creating plist files.
- [skill-email-management](https://clawskills.sh/skills/latisen-skill-email-management) - Expert email management assistant for Apple.
- [testflight-monitor](https://clawskills.sh/skills/jon-xo-testflight-monitor) - Monitor available TestFlight beta slots with smart app lookups and silent batch checking.
- [voice-wake-say](https://clawskills.sh/skills/xadenryan-voice-wake-say) - Speak responses aloud on macOS using the built-in `say`.
